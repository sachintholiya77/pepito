        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                ...
                <img class="logo-compact" src="assets/images/logo2.svg" alt="">
                <img class="brand-title" src="assets/images/logo2.svg" alt="">
				<img class="logo-abbr" src="assets/images/favicon.svg" alt="">
            </a>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
									<div class="header-info">
										<span>Hello, <strong><?= $_SESSION['user_name'] ?? "Admin"?></strong></span>
									</div>
                                    <!-- <img src="assets/images/profile/pic1.jpg" width="20" alt=""> -->
									<img src="<?php echo $profile_image_src; ?>" width="20" alt="Profile Picture">
